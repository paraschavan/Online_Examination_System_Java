...
<title>Admin</title>
<link rel="stylesheet" type="text/css" href="./css/clayout.css">
...
<div><br><br></div>
    ...
    <div class="card">
      <div class="card-image-teacher"></div>
      <div class="card-text">
        ...
        <h2>Teacher</h2>
      	<form method="post" action="UserServlet">
      	    ...
      	    <button class="button-success pure-button button-xlarge">Add New Teacher</button>
      	</form>
      	<form method="post" action="UserServlet">
      				<input type="hidden" name="action" value="edit_user_table">
      				<input type="hidden" name="table" value="staff">
      	    <button class="button-error pure-button button-xlarge">Edit Teacher Data</button>
      	</form>
      </div>
    </div> 
     <div class="card">
