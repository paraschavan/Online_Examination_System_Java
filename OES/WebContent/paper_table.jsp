...
out.println("<button type=\"submit\" class=\"bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded w-full text-3xl\">Add New Paper</button>");
out.println("</form>");
out.println("</div>");%> 
<br>
...
<%
	...
	out.println("<th class=\"px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200 text-2xl\">Select</th>");
	out.println("<th class=\"px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200 text-2xl\">Subject</th>");
	out.println("<th class=\"px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200 text-2xl\">Subject Code</th>");
  ...
  List <Paper> papers =(List)session.getAttribute("papers");
  	for(Paper u: papers){
			...
			out.println("<button class=\"w-full m-px bg-transparent hover:bg-green-500 text-green-700 font-semibold hover:text-white py-2 px-4 border border-green-500 hover:border-transparent rounded text-xl\"  \">Select</button></form>");
			...
			out.println("<button class=\"w-full m-px bg-transparent hover:bg-orange-500 text-orange-700 font-semibold hover:text-white py-2 px-4 border border-orange-500 hover:border-transparent rounded text-xl\">Result</button>");
			
			out.println("</form></td>");
			
			out.println("<td class=\">border-t-2 border-b-2 border-red-200 px-4 py-3 text-white text-xl xl:text-3xl lg:text-3xl md:text-3xl sm:text-3xl\">"+u.getSub()+"</td>");
			out.println("<td class=\">border-t-2 border-b-2 border-red-200 px-4 py-3 text-white text-xl xl:text-3xl lg:text-3xl md:text-3xl sm:text-3xl\">"+u.getSubcode()+"</td>");
			...
			out.println("<button class=\"w-full m-px bg-transparent hover:bg-purple-500 text-purple-700 font-semibold hover:text-white py-2 px-4 border border-purple-500 hover:border-transparent rounded text-xl\">Edit</button>");
